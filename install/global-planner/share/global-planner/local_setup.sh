...
: ${AMENT_CURRENT_PREFIX:="/media/sf_CRATER/Simulation02.04/install/global-planner"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/global-planner/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/global-planner/environment/path.sh"
