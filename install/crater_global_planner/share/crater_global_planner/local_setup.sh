...
: ${AMENT_CURRENT_PREFIX:="/media/sf_CRATER/Simulation02.04/install/crater_global_planner"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/crater_global_planner/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/crater_global_planner/environment/path.sh"
