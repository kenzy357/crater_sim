...
: ${AMENT_CURRENT_PREFIX:="/media/sf_CRATER/Simulation02.04/install/state_estimation"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/state_estimation/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/state_estimation/environment/path.sh"
